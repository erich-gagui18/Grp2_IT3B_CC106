...
public class AdminManagementFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // ⭐️ NEW: Gallery Management Button ⭐️
        // Ensure 'cardManageGallery' exists in XML and the ID exists in NavGraph
        setupNavigationClick(binding.cardManageGallery, R.id.action_admin_nav_management_to_galleryManagementFragment);
    }
